...
Обратите внимание: Code Style в примерах может отличаться от Code Style нашего проекта. Придерживаться надо Code Style, который принят у нас. Code Conv не об этом.
...
Изначально данный документ был [позаимствован](https://github.com/roistat/php-code-conventions) и об опыте использования Code Conv вы можете прочитать в [статье на Хабре](https://habrahabr.ru/company/roistat/blog/352762/).
